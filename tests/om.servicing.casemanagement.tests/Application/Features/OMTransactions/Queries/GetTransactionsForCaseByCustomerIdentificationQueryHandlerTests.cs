...
public class GetTransactionsForCaseByCustomerIdentificationQueryHandlerTests
{
    ...
    public async Task Handle_ReturnsError_WhenCustomerIdentificationNumberIsMissing(string customerId)
    {
        ...
        _transactionServiceMock.Verify(s => s.GetTransactionsForCaseByCustomerIdentificationAsync(It.IsAny<string>(), It.IsAny<String[]?>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task Handle_ReturnsTransactions_WhenServiceReturnsSuccess()
    {
        ...
        _transactionServiceMock
            .Setup(s => s.GetTransactionsForCaseByCustomerIdentificationAsync("cust123", null, CancellationToken.None))
        ...
        _transactionServiceMock.Verify(s => s.GetTransactionsForCaseByCustomerIdentificationAsync("cust123", null, CancellationToken.None), Times.Once);
    }
    ...
    public async Task Handle_ReturnsEmptyData_WhenServiceSucceedsWithNoTransactions()
    {
        ...
        _transactionServiceMock
            .Setup(s => s.GetTransactionsForCaseByCustomerIdentificationAsync("custEmpty", null, CancellationToken.None))
            .ReturnsAsync(serviceResponse);
        ...
        Assert.True(result.Success);
        Assert.Empty(result.Data);
        _transactionServiceMock.Verify(s => s.GetTransactionsForCaseByCustomerIdentificationAsync("custEmpty", null, CancellationToken.None), Times.Once);
    }
    ...
    public async Task Handle_PropagatesErrorsAndCustomExceptions_WhenServiceReturnsFailure()
    {
        ...
        _transactionServiceMock
            .Setup(s => s.GetTransactionsForCaseByCustomerIdentificationAsync("custErr", null, CancellationToken.None))
            .ReturnsAsync(serviceResponse);
        ...
        _transactionServiceMock.Verify(s => s.GetTransactionsForCaseByCustomerIdentificationAsync("custErr", null, CancellationToken.None), Times.Once);
    }
}
