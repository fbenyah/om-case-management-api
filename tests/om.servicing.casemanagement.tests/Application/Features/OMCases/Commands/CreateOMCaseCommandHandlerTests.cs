...
public class CreateOMCaseCommandHandlerTests
{
    private readonly Mock<ILoggingService> _loggingServiceMock;
    private readonly Mock<IOMCaseService> _caseServiceMock;
    private readonly CreateOMCaseCommandHandler _handler;

    public CreateOMCaseCommandHandlerTests()
    {
        _loggingServiceMock = new Mock<ILoggingService>();
        _caseServiceMock = new Mock<IOMCaseService>();
        _handler = new CreateOMCaseCommandHandler(
