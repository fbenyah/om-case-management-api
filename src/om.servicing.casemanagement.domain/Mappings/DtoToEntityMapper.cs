...
public static class DtoToEntityMapper
{
    ...
    public static OMInteraction ToEntity(OMInteractionDto dto) => new OMInteraction
    {
        ...
        Status = dto.Status,
        ReferenceNumber = dto.ReferenceNumber,
        IsPrimaryInteraction = dto.IsPrimaryInteraction,
    ...
    public static OMTransaction ToEntity(OMTransactionDto dto) => new OMTransaction
    {
        ...
        IsFulfilledExternally = dto.IsFulfilledExternally,
        ExternalSystem = dto.ExternalSystem,
        ExternalSystemId = dto.ExternalSystemId,
        ExternalSystemParentId = dto.ExternalSystemParentId,
        ExternalSystemStatus = dto.ExternalSystemStatus,        
        ReferenceNumber = dto.ReferenceNumber,
        ParentReferenceNumber = dto.ParentReferenceNumber,
